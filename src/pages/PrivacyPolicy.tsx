            ...
            <div className="font-serif-heading" style={{ display: "flex", flexDirection: "column", gap: "2rem", lineHeight: "1.8", color: "var(--color-text-dark)" }}>
              <div>
                ...
                <ul style={{ paddingLeft: "1.5rem", color: "var(--color-text-muted)", marginBottom: "1rem", display: "flex", flexDirection: "column", gap: "6px" }}>
                  <li><strong>Identity Information:</strong> Name, age, gender, and social profiles.</li>
                  <li><strong>Contact Information:</strong> Email address, phone number, and physical mailing address.</li>
                  <li><strong>Financial Information:</strong> Transaction IDs and payment summaries (we do NOT store credit card details or bank passwords).</li>
                  <li><strong>Tax Identification:</strong> PAN card number (required exclusively for generating Indian Income Tax Section 80G receipts).</li>
                </ul>
              </div>
